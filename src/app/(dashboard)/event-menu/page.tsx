...
import { UtensilsCrossed, Calendar, Users, MapPin, ArrowRight, Search } from "lucide-react"
              ...
              <Link key={event.id} href={`/event-menu/${event.id}`}>
                <Card hover className="h-full">
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    <div className="flex items-center gap-2"><Calendar className="w-4 h-4" /><span>{formatDate(event.functionDate)}</span></div>
